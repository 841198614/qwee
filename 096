...
local accessorylimbs={
	...
	{meshid="16345813196",textureid="",C0=angles(1.5707963267948966,0,1.5707963267948966),Name="Left Arm"},
	{meshid="16345813195",textureid="",C0=angles(-1.5707963267948966,0,1.5707963267948966),Name="Right Arm"},
	...
	{meshid="11159370334",textureid="",C0=angles(1.5707963267948966,0,1.5707963267948966),Name="Left Leg"},

	{meshid="16345813195",textureid="",C0=angles(0,0,1.5707963267948966),Name="Left Leg"},
	{meshid="1086413449",textureid="",C0=angles(0,0,1.5707963267948966),Name="Right Leg"},


	{meshid="1086413449",textureid="",C0=cf_0,Name="Torso"},
	{meshid="14241018198",textureid="",C0=cf_0,Name="Torso"},
	{meshid="13421774668",textureid="",C0=cf_0,Name="Torso"},

	{meshid="4324138105",textureid="4324138210",C0=cfMul(angles(-1.6144295580947547,1.5707963267948966,0),cf(-0.125,0.1,0)),Name="Left Arm"},
	{meshid="4154474745",textureid="4154474807",C0=cfMul(angles(1.5271630954950384,-1.5707963267948966,0),cf(-0.125,-1.5,0)),Name="Left Arm"},
	{meshid="3030546036",textureid="3650191503",C0=cfMul(angles(1.5271630954950384,1.5707963267948966,0),cf(0.125,-1.5,0)),Name="Right Arm"},
	{meshid="3030546036",textureid="3443321249",C0=cfMul(angles(-1.6144295580947547,-1.5707963267948966,0),cf(0.125,0.1,0)),Name="Right Arm"},
	{meshid="3030546036",textureid="3360974849",C0=cfMul(angles(1.5271630954950384,1.5707963267948966,0),cf(-0.125,-1.5,0)),Name="Left Leg"},
	...
	{meshid="3030546036",textureid="3033898741",C0=cfMul(angles(1.5271630954950384,-1.5707963267948966,0),cf(0.125,-1.5,0)),Name="Right Leg"},
	...
	{meshid="16345813195",textureid="14437672845",C0=cfMul(angles(1.5271630954950384,1.5707963267948966,0),cf(0.125,-1.5,0)),Name="Right Arm"},
	{meshid="14768683674",textureid="14768683674",C0=cfMul(angles(1.5271630954950384,1.5707963267948966,0),cf(0.125,-1.5,0)),Name="Right Arm"},
	{meshid="11159370334",textureid="11159284657",C0=cfMul(angles(1.5707963267948966,0,1.5707963267948966),cf(0,-1.6,0)),Name="Right Arm"},
	{meshid="16345813195",textureid="14437672845",C0=cfMul(angles(1.5707963267948966,0,1.5707963267948966),cf(0,-1.6,0)),Name="Left Arm"},
	{meshid="17387586286",textureid="17387586304",C0=cfMul(angles(1.5707963267948966,0,1.5707963267948966),cf(0,-1.6,0)),Name="Left Leg"},
	{meshid="1086413449",textureid="1461576423",C0=cfMul(angles(1.5707963267948966,0,1.5707963267948966),cf(0,-1.6,0)),Name="Right Leg"},
	{meshid="1086413449",textureid="1086413455",C0=angles(0,0,0.2617993877991494),Name="Torso"}
}
...
btn("SCP 096", function()
    ...
    local downtorso = getPartFromMesh(1829131265,1829125781)
    local downtorsoweld = getPartJoint(downtorso)
    local rightbackpackleg = getPartFromMesh(686793422,6900595602)
    local rightbackpacklegweld = getPartJoint(rightbackpackleg)
    local leftbackpackleg = getPartFromMesh(3302560140,3302560467)
    local leftbackpacklegweld = getPartJoint(leftbackpackleg)
    local righttopfedoraleg = getPartFromMesh(3030546036,4622077774)
    local righttopfedoralegweld = getPartJoint(righttopfedoraleg)
...
LeftShoulder.C0=Lerp(LeftShoulder.C0,cfMul(cf(-1,0,-1.5),angles(-1.3962634015954636,-2.443460952792061,-2.443460952792061)),deltaTime) 
LeftHip.C0=Lerp(LeftHip.C0,cfMul(cf(-0.6,0.2,-2),angles(0.4363323129985824-0.017453292519943295*sin(sine*5),3.141592653589793,0.17453292519943295)),deltaTime) 
RootJoint.C0=Lerp(RootJoint.C0,cfMul(cf(0,-1,0),angles(-1.7453292519943295+0.017453292519943295*sin(sine*5),0,3.141592653589793)),deltaTime) 
Neck.C0=Lerp(Neck.C0,cfMul(cf(0,1,0),angles(-1.9198621771937625,0,3.141592653589793)),deltaTime) 
RightShoulder.C0=Lerp(RightShoulder.C0,cfMul(cf(1,0,-1.5),angles(-1.3962634015954636,2.443460952792061,2.443460952792061)),deltaTime) 
RightHip.C0=Lerp(RightHip.C0,cfMul(cf(0.6,0.2,-2),angles(0.4363323129985824-0.017453292519943295*sin(sine*5),3.141592653589793,-0.17453292519943295)),deltaTime) 
...
RightShoulder.C0=Lerp(RightShoulder.C0,cfMul(cf(1,-1,-1.5),angles(0.17453292519943295,1.5707963267948966,0.3490658503988659+0.017453292519943295*sin(sine*5))),deltaTime) 
RootJoint.C0=Lerp(RootJoint.C0,cfMul(cf(0,2+0.05*sin(sine*5),0),angles(-1.7453292519943295,0,3.141592653589793)),deltaTime) 
Neck.C0=Lerp(Neck.C0,cfMul(cf(0,1+0.1*sin(sine*1),0),angles(-2.443460952792061,0,3.141592653589793)),deltaTime) 
RightHip.C0=Lerp(RightHip.C0,cfMul(cf(1,-3,1 * sin(sine*5)),angles(0,1.5707963267948966,-0.2617993877991494*sin(sine*5))),deltaTime) 
LeftShoulder.C0=Lerp(LeftShoulder.C0,cfMul(cf(-1,-1,-1.5),angles(0.17453292519943295,-1.5707963267948966,-0.3490658503988659+0.017453292519943295*sin(sine*5))),deltaTime) 
LeftHip.C0=Lerp(LeftHip.C0,cfMul(cf(-1,-3,-1 * sin(sine*5)),angles(0,-1.5707963267948966,-0.2617993877991494*sin(sine*5))),deltaTime) 
end,
		jump = function()
			velYchg()
			local Vfw, Vrt = velbycfrvec()
...
RootJoint.C0=Lerp(RootJoint.C0,cfMul(cf(0,0.05 * sin(sine*5),0),angles(-2.2689280275926285,0,3.141592653589793+0.17453292519943295*sin(sine*5))),deltaTime) 
LeftShoulder.C0=Lerp(LeftShoulder.C0,cfMul(cf(-1.5,1,-3+2*sin(sine*5)),angles(1.5707963267948966,3.141592653589793+0.7853981633974483*sin(sine*5),-0.7853981633974483*sin(sine*5))),deltaTime) 
Neck.C0=Lerp(Neck.C0,cfMul(cf(0,1+0.1*sin(sine*10),0),angles(-1.5707963267948966+0.17453292519943295*sin(sine*10),0,3.141592653589793)),deltaTime) 
RightHip.C0=Lerp(RightHip.C0,cfMul(cf(1.5,-3-0.05*sin(sine*5),0),angles(-0.6981317007977318-0.17453292519943295*sin(sine*5),1.3962634015954636,0)),deltaTime) 
RightShoulder.C0=Lerp(RightShoulder.C0,cfMul(cf(1.5,1,-3-2*sin(sine*5)),angles(1.5707963267948966,3.141592653589793+0.7853981633974483*sin(sine*5),-0.7853981633974483*sin(sine*5))),deltaTime) 
LeftHip.C0=Lerp(LeftHip.C0,cfMul(cf(-1.5,-3-0.05*sin(sine*5),0),angles(-0.6981317007977318+0.17453292519943295*sin(sine*5),-1.3962634015954636,0)),deltaTime) end
	})
	addmode("e", {
		idle = function()
			velYchg()

LeftHip.C0=Lerp(LeftHip.C0,cfMul(cf(-1,-3,3 * sin(sine*3)),angles(-1.5707963267948966*sin(sine*3),-1.5707963267948966,0)),deltaTime) 
Neck.C0=Lerp(Neck.C0,cfMul(cf(0,1,0),angles(-1.5707963267948966,0,3.141592653589793)),deltaTime) 
RightShoulder.C0=Lerp(RightShoulder.C0,cfMul(cf(1,1.5+0.1*sin(sine*10),0),angles(-0.5235987755982988,2.9670597283903604,2.6179938779914944)),deltaTime) 
LeftShoulder.C0=Lerp(LeftShoulder.C0,cfMul(cf(-1,1.5+0.1*sin(sine*10),0),angles(-0.5235987755982988,-2.9670597283903604,-2.6179938779914944)),deltaTime) 
RootJoint.C0=Lerp(RootJoint.C0,cfMul(cf(0,2,0),angles(-1.5707963267948966+1.5707963267948966*sin(sine*3),0,3.141592653589793+0.2617993877991494*sin(sine*3))),deltaTime) 
RightHip.C0=Lerp(RightHip.C0,cfMul(cf(1,-3,3 * sin(sine*3)),angles(-1.5707963267948966*sin(sine*3),1.5707963267948966,0)),deltaTime) end
	})
	addmode("r", {
		idle = function()
			local Ychg=velYchg()/20

Neck.C0=Lerp(Neck.C0,cfMul(cf(0,1+0.1*sin(sine*10),0),angles(-1.5707963267948966+0.3490658503988659*sin(sine*10),0,3.141592653589793)),deltaTime) 
LeftShoulder.C0=Lerp(LeftShoulder.C0,cfMul(cf(-1.5,1,-3+4*sin(sine*10)),angles(2.6179938779914944+0.17453292519943295*sin(sine*10),3.141592653589793+0.17453292519943295*sin(sine*10),0.17453292519943295*sin(sine*10))),deltaTime) 
RightHip.C0=Lerp(RightHip.C0,cfMul(cf(1.5,-3.5+1*sin(sine*10),-1+1*sin(sine*10)),angles(-0.6981317007977318,1.3962634015954636,0)),deltaTime) 
LeftHip.C0=Lerp(LeftHip.C0,cfMul(cf(-1.5,-3.5+1*sin(sine*10),-1+1*sin(sine*10)),angles(-0.6981317007977318,-1.3962634015954636,0)),deltaTime) 
RootJoint.C0=Lerp(RootJoint.C0,cfMul(cf(0,1+0.05*sin(sine*5),0),angles(-2.2689280275926285+0.3490658503988659*sin(sine*10),0,3.141592653589793+0.08726646259971647*sin(sine*10))),deltaTime) 
RightShoulder.C0=Lerp(RightShoulder.C0,cfMul(cf(1.5,1,-3+4*sin(sine*10)),angles(2.6179938779914944-0.17453292519943295*sin(sine*10),3.141592653589793-0.17453292519943295*sin(sine*10),-0.17453292519943295*sin(sine*10))),deltaTime) end
	})
	addmode("t", {
...
RootJoint.C0=Lerp(RootJoint.C0,cfMul(cf(0,2,0),angles(-2.0943951023931953,0,3.141592653589793)),deltaTime) 
LeftHip.C0=Lerp(LeftHip.C0,cfMul(cf(-1,-3,0),angles(0,-1.5707963267948966,0.5235987755982988)),deltaTime) 
RightHip.C0=Lerp(RightHip.C0,cfMul(cf(1,-3,0),angles(0,1.5707963267948966,-0.5235987755982988)),deltaTime) 
Neck.C0=Lerp(Neck.C0,cfMul(cf(0,1,0),angles(-1.2217304763960306,0,3.141592653589793)),deltaTime) 
RightShoulder.C0=Lerp(RightShoulder.C0,cfMul(cf(1,1.5,-2.5),angles(0,1.3962634015954636,2.2689280275926285)),deltaTime) 
LeftShoulder.C0=Lerp(LeftShoulder.C0,cfMul(cf(-1,1.5,-2.5),angles(0,-1.3962634015954636,-2.2689280275926285)),deltaTime) end,
		walk = function()
			velYchg()
			local Vfw, Vrt = velbycfrvec()
...
Neck.C0=Lerp(Neck.C0,cfMul(cf(0.1 * sin((sine+5)*50),1+0.1*sin(sine*50),0),angles(-1.0471975511965976,0,3.141592653589793)),deltaTime) 
RightShoulder.C0=Lerp(RightShoulder.C0,cfMul(cf(3+0.1*sin((sine+5)*50),0.5+0.1*sin(sine*50),-0.5),angles(1.7453292519943295,3.141592653589793,-0.8726646259971648)),deltaTime) 
LeftHip.C0=Lerp(LeftHip.C0,cfMul(cf(-1-0.1*sin(sine*100),-3-0.1*sin(sine*100),0),angles(-0.17453292519943295,-1.3962634015954636,0)),deltaTime) 
RightHip.C0=Lerp(RightHip.C0,cfMul(cf(1-0.1*sin(sine*100),-3-0.1*sin(sine*100),0),angles(-0.17453292519943295,1.3962634015954636,0)),deltaTime) 
LeftShoulder.C0=Lerp(LeftShoulder.C0,cfMul(cf(-3+0.1*sin((sine+5)*50),0.5+0.1*sin(sine*50),-0.5),angles(1.7453292519943295,3.141592653589793,0.8726646259971648)),deltaTime) 
RootJoint.C0=Lerp(RootJoint.C0,cfMul(cf(0.1 * sin((sine+1)*50),2+0.1*sin(sine*100),0),angles(-1.3962634015954636,0,3.141592653589793)),deltaTime) end
	})
	addmode("u", {
		idle = function()
			velYchg()
...
RightHip.C0=Lerp(RightHip.C0,cfMul(cf(0.6,0.2,-2),angles(0.4363323129985824-0.017453292519943295*sin(sine*5),3.141592653589793,-0.17453292519943295)),deltaTime) 
RightShoulder.C0=Lerp(RightShoulder.C0,cfMul(cf(1.2,1,0),angles(0,2.9670597283903604,2.0943951023931953)),deltaTime) 
RootJoint.C0=Lerp(RootJoint.C0,cfMul(cf(0,-1,0),angles(-1.7453292519943295+0.017453292519943295*sin(sine*5),0,3.141592653589793)),deltaTime) 
LeftHip.C0=Lerp(LeftHip.C0,cfMul(cf(-0.6,0.2,-2),angles(0.4363323129985824-0.017453292519943295*sin(sine*5),3.141592653589793,0.17453292519943295)),deltaTime) 
Neck.C0=Lerp(Neck.C0,cfMul(cf(0,1,0),angles(-2.2689280275926285,0,3.141592653589793)),deltaTime) 
LeftShoulder.C0=Lerp(LeftShoulder.C0,cfMul(cf(-1.2,1,0),angles(0,-2.9670597283903604,-2.0943951023931953)),deltaTime) end,
		walk = function()
			local Ychg=velYchg()/20
			local Vfw, Vrt = velbycfrvec()
...
RightHip.C0=Lerp(RightHip.C0,cfMul(cf(1.2,-2.5+0.5*sin((sine+1)*10),3 * sin(sine*10)),angles(0,1.5707963267948966,-0.8726646259971648*sin(sine*10))),deltaTime) 
LeftShoulder.C0=Lerp(LeftShoulder.C0,cfMul(cf(-1.5,1-0.2*sin(sine*25),-3),angles(1.7453292519943295+0.17453292519943295*sin(sine*25),-1.2217304763960306,0)),deltaTime) 
Neck.C0=Lerp(Neck.C0,cfMul(cf(0,1,0),angles(-1.3962634015954636,0,3.141592653589793)),deltaTime) 
LeftHip.C0=Lerp(LeftHip.C0,cfMul(cf(-1.2,-2.5+0.5*sin((sine+1)*-10),-3 * sin(sine*10)),angles(0,-1.5707963267948966,-0.8726646259971648*sin(sine*10))),deltaTime) 
RootJoint.C0=Lerp(RootJoint.C0,cfMul(cf(0,1.5+0.2*sin(sine*25),0),angles(-1.5707963267948966,0,3.141592653589793)),deltaTime) 
RightShoulder.C0=Lerp(RightShoulder.C0,cfMul(cf(1.5,1-0.2*sin(sine*25),-3),angles(1.7453292519943295+0.17453292519943295*sin(sine*25),1.2217304763960306,0)),deltaTime) end,
		modeLeft = function()
			setWalkSpeed(25)
		end,
	})
